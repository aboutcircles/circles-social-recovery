...
contract HubStorageWrites is Test {
    ...
    function _simulateSafe(address avatar) internal {
        vm.etch(
            avatar,
        ...
        // set implementation
        vm.store(avatar, 0, bytes32(uint256(uint160(0x29fcB43b46531BcA003ddC8FCB67FFE91900C762))));
        ...
        vm.store(avatar, moduleSlot, bytes32(uint256(1)));
    }
}
